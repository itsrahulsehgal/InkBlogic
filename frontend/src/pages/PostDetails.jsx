...
const PostDetails = () => {
  ...
  const handleDeletePost=async ()=>{
    ...
    try{
      const res=await axios.delete("https://ink-blogic-backend.vercel.app/api/posts/"+postId,{withCredentials:true})
      console.log(res.data)
      navigate("/")
  ...
  const fetchPostComments=async()=>{
    setLoader(true)
    try{
      const res=await axios.get("https://ink-blogic-backend.vercel.app/api/comments/post/"+postId)
  ...
  const postComment=async(e)=>{
    e.preventDefault()
    try{
      const res=await axios.post("https://ink-blogic-backend.vercel.app/api/comments/create",
